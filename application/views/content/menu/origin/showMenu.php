...
<head>
    ...
    <title>Naija Foodies Origin</title>
...
<input type="hidden" value="<?php echo $originId; ?>" id="origin-id">
...
<script src="<?php echo base_url(); ?>assets/js/custom/menu/origin/menuOriginDataPoint.js"></script>
<script src="<?php echo base_url(); ?>assets/js/custom/menu/origin/menuOrigin.js"></script>
