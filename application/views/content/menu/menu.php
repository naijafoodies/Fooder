...
<head>
    ...
    <title>Naija Foodies || Menu</title>
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-8 menu-grid center-block">
...
<script src="<?php echo base_url(); ?>assets/js/custom/menu/menuDataPoint.js"></script>
<script src = "<?php echo base_url(); ?>assets/js/custom/menu/nfMenu.js"></script>
