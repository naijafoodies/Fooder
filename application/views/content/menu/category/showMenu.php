...
<head>
    ...
    <title>Naija Foodies Category</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/custom/main-menu.css" />
...
<input type="hidden" value="<?php echo $categoryId; ?>" id="category-id">
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-8 menu-grid">

            <div class="w3-card">
                <div class="card-columns" id="menu-container">
...
<script src="<?php echo base_url(); ?>assets/js/custom/menu/category/menuCategoryDataPoint.js"></script>
<script src="<?php echo base_url(); ?>assets/js/custom/menu/category/menuCategory.js"></script>
