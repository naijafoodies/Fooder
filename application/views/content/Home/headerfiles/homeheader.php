...
<nav class="navbar navbar-toggleable-md navbar-light site-header" style="background-color : #ffffff;">
    ...
    <a href="<?php echo base_url();?>FoodDisplay">
      <img class="brand" src="<?php echo base_url(); ?>images/logo/headerlogo1.png" alt="Naija Foodies" width="120" height="50"/>
    </a>
