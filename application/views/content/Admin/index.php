...
<h1 class="text-center" style="margin-top: 50px; font-family: 'Fredericka the Great', cursive;"><span style="color: green;">Naija</span> <spanm style = "color:red;">Foodies</span></h1>
	...
	<div class="col-sm-4 text-center center-block" id="centerPanel">
		...
		<div class="uk-card uk-card-default uk-card-hover uk-card-small uk-card-body">
			...
			<div class="uk-card-header">
            	<h3 class="uk-card-title">Admin Login</h3>
	...
	<script>
		...
		{	
			...
			if(valid)
			{
				...
				$.post('<?php echo base_url() ?>AdminManagement/validateLogin',
				{
					username:username,
					password:password
				},
				function(response)
				{
					switch(response)
					{
						...
						case '2':
							location.assign('<?php echo base_url(); ?>AdminManagement/mainConsole');
						break;
