...
<div class="modal-footer">
	...
	<div class="ui animated red button" tabindex="0" onclick="submitDeleteMeat()">
...
<script>
	function submitDeleteMeat()
	{
		/**
		*	Function confirms deletion of food
		*/

		var meatId = "<?php echo $meatId; ?>";

		$.post('<?php echo base_url() ?>AdminManagement/submitDeleteMeat',
		{
			meatId:meatId
		},function(response)
		{
			...
			UIkit.notification({
			    message: 'Meat have been successfully removed from the database',
			    status: 'success',
			    pos: 'top-right',
			    timeout: 200
			});
			...
			location.assign('<?php echo base_url(); ?>AdminManagement/viewMeatInventory');
		});
	}
</script>