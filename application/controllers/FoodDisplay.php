...
class FoodDisplay extends CI_Controller
{
    ...
    public function viewMenu()
    {
      ...
      $searchkeyword = ($this->input->post('keyword'))?$this->input->post('keyword'):NULL;

      $params = array('FoodName'=>$searchkeyword);
      ...
      $data['allFoodDetails'] = $this->FoodDisplayModel->grabAllMenuItems($params);
      $data['cartDetails'] = $this->FoodDisplayModel->grabCartDetails($uniqueSessionId);
    ...
    public function updateMenu()
    {
      ...
      */
      ...
      $searchkeyword = ($this->input->post('keyword'))?$this->security->xss_clean($this->input->post('keyword')):NULL;
    ...
    public function grabLikelyMenu()
    {
      ...
      if($keyword)
      {
        $data['menuDetails'] = $this->FoodDisplayModel->grabLikelyMenu($keyword);

        echo json_encode($data['menuDetails']);
      }
